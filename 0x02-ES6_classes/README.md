...
4. Import the class Currency from 3-currency.js Implement a class named `Pricing`:
...
6. Import Building from 5-building.js. Implement a class named `SkyHighBuilding` that extends from Building:
